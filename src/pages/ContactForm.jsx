...
const avatarColors = ["#8cdccd", "#8CDCCD", "#a5e8dc", "#38f1cf", "#b2f5ea"];
...
const [message, setMessage] = useState("");
    ...
    selectedSubject)}&body=${encodeURIComponent(message)}`;

    window.location.href = link;
    }

    return (
    <div style={{ backgroundColor: "#e6eeed", minHeight: "100vh", padding: "2rem", fontFamily: font, fontWeight: "bold", textAlign: "center" }}>
        <div style={{ maxWidth: 900, margin: "0 auto"}}>
            <h1 style={{ color: "#091211", fontWeight: 500 }}>Contact our team </h1>
            <p style={{ color: "#198c77", marginTop: 0, marginBottom: "2rem" }}> Reach the right person directly </p>
...
{/* Team Cards */}
        ...
        <div
            key={member.id}
            onMouseEnter={(e) => {
            e.currentTarget.style.boxShadow = "0 0 18px #38f1cf";
            e.currentTarget.querySelector("span").style.boxShadow = "0 0 10px #38f1cf";
            }}
            onMouseLeave={(e) => {
            e.currentTarget.style.boxShadow = "none";
            e.currentTarget.querySelector("span").style.boxShadow = "none";
            }}
            style={{
